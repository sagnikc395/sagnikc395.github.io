...
<section class="layout-md py-12">
	...
	<p class="text-lg mb-4">
		...
		>. It lets me quickly act on inspiration, delve into new topics, and make tools that improve
		people's lives.
	</p>

	<p class="text-lg mb-4">
		You'll see that I particularly like programming languages, distributed systems, machine
		learning, computer graphics, music, and art.
	</p>
...
<div class="bg-neutral-50 border-b border-neutral-200 py-4">
	<div class="flex justify-center space-x-6">
		...
		<button class:active={sortOrder === 'stars'} on:click={() => (sortOrder = 'stars')}>
