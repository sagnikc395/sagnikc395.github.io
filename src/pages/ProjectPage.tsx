...
const ProjectPage: React.FC = () => {
	...
	return (
		<>
			<Seo title={`Sagnik Chatterjee - ${project.title}`} description={project.title} />

			<section className="layout-md py-10">
				<Link to="/projects" className="text-stone-400 hover:text-stone-100 mb-8 inline-block">
					&larr; Back to projects
				</Link>
				<ProjectDetail data={project} images={images} imagePrefix="../projects/" />
			</section>
		</>
	);
};
