		...
		<>
			...
			<section className="layout-md py-12 space-y-10">
					...
					<div className="space-y-4">
						<div>
							<div className="flex justify-between items-end">
								<h3 className="text-lg font-semibold text-stone-100">University of Massachusetts, Amherst</h3>
								<p className="text-stone-400 text-sm">2025 — 2027</p>
							</div>
							<p className="font-serif italic text-stone-300">M.S. in Computer Science</p>
						</div>

						<div>
							<div className="flex justify-between items-end">
								<h3 className="text-lg font-semibold text-stone-100">Manipal Institute of Technology, Manipal</h3>
								<p className="text-stone-400 text-sm">2018 — 2022</p>
							</div>
							<p className="font-serif italic text-stone-300">B.Tech in Computer Science & Engineering</p>
						</div>
					</div>
				</div>
				...
				<div>
					...
					<div>
						<h3 className="font-medium mb-2 text-stone-100">Graduate Research (Fall 2025)</h3>
						<Workplace
					...
					<div>
						...
						<div className="mb-10">
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
								{[
									{ id: 'COMPSCI 590NN', name: 'Neural Networks in AI and Neuroscience' },
									...
									>
										<span className="text-stone-500 text-xs font-mono mb-1">{course.id}</span>
						...
						<div className="mb-10">
							...
							<div className="flex flex-wrap gap-2">
								{[
									{ id: 'COMPSCI 685', name: 'Advanced Natural Language Processing' },
									...
									>
										<span className="text-stone-500 text-xs font-mono">{course.id}</span>
										<span className="text-stone-300 text-sm font-medium">{course.name}</span>
									</div>
								))}
							</div>
						</div>
