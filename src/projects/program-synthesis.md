...
- Building an Javascript like intrepreted language :

ref: [monkey](https://github.com/sagnikc395/monkey) <br />
notes: [notes on building an interpreter](https://sc4-knowledge-base.vercel.app/notes/programming-languages/)
